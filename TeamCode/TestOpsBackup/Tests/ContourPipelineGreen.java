...
public class ContourPipelineGreen extends OpenCvPipeline {
    ...
    public ContourPipelineGreen(double borderLeftX, double borderRightX, double borderTopY, double borderBottomY) {
